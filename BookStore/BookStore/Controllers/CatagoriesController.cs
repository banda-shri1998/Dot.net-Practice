...
namespace BookStore.Controllers
{
    public class CatagoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,BookType")] Catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,BookType")] Catagory catagory)
        {
            if (ModelState.IsValid)
            {
                db.Catagories.Attach(catagory);
